...
namespace Food_Recipes
{
    public partial class Category : UserControl
    {
       ...
       public List<Image> img;
           ...
           int leftPadding = 80;      
            ...
            if(categoryName!=null)
            {
                for (int x = 0; x < cat; x = x + 1) 
                {
                    ...
                    {
                        count = 0;               
                        topPadding = topPadding + rectangleRange;//box deka athara dura
                    }

                    g.DrawRectangle(new Pen(Color.Black), (count * rectangleRange) + leftPadding, topPadding, rectangleWidth, rectangleWidth);
                    g.FillRectangle(Brushes.Chocolate, new Rectangle((count * rectangleRange) + leftPadding, topPadding, rectangleWidth, rectangleWidth));//box eka adinna gannna ida paramanaya
                    ...
                    //form eke uda idan adinna patan ganna thenata usa
        ...
        {
            //take x y valueof click using click event
           indexX = (int)(e.X);
          indexY = (int)(e.Y);
