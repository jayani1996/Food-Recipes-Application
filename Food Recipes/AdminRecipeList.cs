...
namespace Food_Recipes
{
    ...
    {
        SqlConnection con = new SqlConnection("Data Source=DESKTOP-AM7OELU\\MYSQLSERVER;Initial Catalog=FoodRecipes;Integrated Security=True");
        ...
        {
            AdminDashboard list = new AdminDashboard();
